...
public class PagingSpirit {
    public static final TextComponentString PAGE_BACK = new TextComponentString("§b[<]§r");
    public static final TextComponentString PAGE_NEXT = new TextComponentString("§b[>]§r");
    public static final TextComponentString PAGE_START = new TextComponentString("§7[<]§r");
    public static final TextComponentString PAGE_END = new TextComponentString("§7[>]§r");
    ...
    public void fetchPage(@Nonnull List<TextComponentString> messages, int beginIndex, String guild) {
        ...
        end = (beginIndex - MAX_INDEX > 1 ? PAGE_BACK : PAGE_START).appendSibling(new TextComponentString(" --- " + beginIndex + "/" + size + " --- ")).appendSibling((beginIndex + MAX_INDEX < size ? PAGE_NEXT : PAGE_END));
